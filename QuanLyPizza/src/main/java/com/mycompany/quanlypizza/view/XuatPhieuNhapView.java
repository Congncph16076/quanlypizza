...
public class XuatPhieuNhapView extends javax.swing.JDialog {
    ...
    private List<CTPhieuNhap> listCTPhieuNhap = null;
    private int tongTien;
    private boolean checkNhap = false;
    String nhaCungCap;
    String nhanVien;

    public XuatPhieuNhapView(String nhaCungCap, String nhanVien, List<CTPhieuNhap> listCTPhieuNhap) {
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        // lưu phiếu nhập
        PhieuNhapServiceImp phieuNhapServiceImp = new PhieuNhapServiceImp();
        phieuNhapServiceImp.themPhieuNhap(nhaCungCap, nhanVien, tongTien);

        int maPN = phieuNhapServiceImp.getLastID();
        ChiTietPhieuNhapServiceImp ctpnsimp = new ChiTietPhieuNhapServiceImp();
        String hd = "<style> "
                + "table {"
                + "border: 1px solid;"
                + "border-bottom: none"
        ...
        for (CTPhieuNhap ctpn : listCTPhieuNhap) {
            ...
            //===================================================
            ctpn.setMaPN(maPN);
            ctpnsimp.luuCTPhieuNhap(ctpn);
            System.out.println("lưu ok: " + maPN);
        }
        ...
        new MyDialogCommon("Đã xác nhận", MyDialogCommon.SUCCESS_DIALOG);
