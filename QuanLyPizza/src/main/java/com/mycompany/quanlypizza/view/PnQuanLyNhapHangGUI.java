...
import com.mycompany.quanlypizza.service.ChiTietPhieuNhapServiceImp;
import com.mycompany.quanlypizza.service.LoaiServiceImp;
import com.mycompany.quanlypizza.service.NhanVienServiceImp;
import com.mycompany.quanlypizza.service.PhieuNhapServiceImp;
...
public class PnQuanLyNhapHangGUI extends javax.swing.JPanel {
    ...
    private PhieuNhapServiceImp phieuNhapServiceImp = new PhieuNhapServiceImp();
    private ChiTietPhieuNhapServiceImp chiTietPhieuNhapServiceImp = new ChiTietPhieuNhapServiceImp();
    ...
    private void customControl() {
        ...
        dtmKho.addColumn("Mã SP");
        dtmKho.addColumn("Tên SP");
        dtmKho.addColumn("Tồn kho");
        tblKho.setModel(dtmKho);
        
        dtmGioNhap = new DefaultTableModel();
        dtmGioNhap.addColumn("Mã SP");
        dtmGioNhap.addColumn("Tên SP");
        dtmGioNhap.addColumn("Số lượng");
        dtmGioNhap.addColumn("Đơn giá");
        dtmGioNhap.addColumn("Thành tiền");
        ...
        dtmPhieuNhap.addColumn("Mã phiếu nhập");
        dtmPhieuNhap.addColumn("Ngày lập");
        dtmPhieuNhap.addColumn("Tổng tiền");
        ...
        dtmCTPhieuNhap.addColumn("Mã SP");
        dtmCTPhieuNhap.addColumn("Số Lượng");
        dtmCTPhieuNhap.addColumn("Đơn giá");
        dtmCTPhieuNhap.addColumn("Thành tiền");
    ...
    private void loadDataCmbNhanVien() {
        ...
        List<NhanVien> lstNV = nhanVienServiceImp.getDSNV();
        if (lstNV != null) {
...
//        }
    ...
    private void loadDataTableKho() {
        ...
        List<SanPham> lstSP = sanPhamServiceImp.getListSP();
        SanPhamRespository loaiRespository = new SanPhamRespository();
        
        for (SanPham sp : lstSP) {
            if (sp.getLoaiSP().getMaLoai() != 1) {
    ...
    private void loadDataTableKho(String tuKhoa) {
        dtmKho.setRowCount(0);
        List<SanPham> lstSP = sanPhamServiceImp.getListSPByName(tuKhoa);
        SanPhamRespository loaiRespository = new SanPhamRespository();
    ...
    private void loadDataTablePhieuNhap() {
        List<PhieuNhap> lst = phieuNhapServiceImp.getListPhieuNhap();
        duaDataVaoTablePhieuNhap(lst);
    }
    
    public void duaDataVaoTablePhieuNhap(List<PhieuNhap> lstPN) {
        if (lstPN != null) {
    ...
    private void loadDataTablePhieuNhapTheoNgay(String tuNgay, String denNgay) {
        ...
        List<PhieuNhap> dspn = phieuNhapServiceImp.getListPhieuNhapTheoNgay(tuNgay, denNgay);
        duaDataVaoTablePhieuNhap(dspn);
    }
    
    private void loadDataTablePhieuNhapTheoGia(String giaThap, String giaCao) {
        List<PhieuNhap> lstPN = phieuNhapServiceImp.getListPhieuNhapTheoGia(giaThap, giaCao);
        duaDataVaoTablePhieuNhap(lstPN);
    }
    
    private void loadDataTableCTPhieuNhap() {
        dtmCTPhieuNhap.setRowCount(0);
        List<CTPhieuNhap> lstCTPN = chiTietPhieuNhapServiceImp.getListCTPhieuNhap();
        if (lstCTPN != null) {
            for (CTPhieuNhap ct : lstCTPN) {
                Vector vec = new Vector();
                vec.add(ct.getMaSP());
                vec.add(dcf1.format(ct.getSoLuong()));
    ...
    private void loadDataTableCTPhieuNhap(String maPN) {
        dtmCTPhieuNhap.setRowCount(0);
        List<CTPhieuNhap> lstCTPN = chiTietPhieuNhapServiceImp.getListCTPhieuNhap(maPN);
        if (lstCTPN != null) {
            for (CTPhieuNhap ct : lstCTPN) {
                Vector vec = new Vector();
                vec.add(ct.getMaSP());
    ...
    private void initComponents() {
        ...
        tblPhieuNhap = new MyTableCommon();
        ...
        tblCTPhieuNhap = new MyTableCommon();
        ...
        btnResetKho.setIcon(new javax.swing.ImageIcon("C:\\Users\\congc\\Documents\\NetBeansProjects\\QuanLyPizza\\image\\Refresh-icon.png")); // NOI18N
        ...
        btnTimKiem.setIcon(new javax.swing.ImageIcon("C:\\Users\\congc\\Documents\\NetBeansProjects\\QuanLyPizza\\image\\Search-icon.png")); // NOI18N
        ...
        pnTableLayout.setVerticalGroup(
            ...
            .addGroup(pnTableLayout.createSequentialGroup()
                ...
                .addComponent(scrTblKho, javax.swing.GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        btnXoaKhoiGio.setIcon(new javax.swing.ImageIcon("C:\\Users\\congc\\Documents\\NetBeansProjects\\QuanLyPizza\\image\\delete-icon.png")); // NOI18N
        ...
        btnXacNhan.setIcon(new javax.swing.ImageIcon("C:\\Users\\congc\\Documents\\NetBeansProjects\\QuanLyPizza\\image\\check-icon.png")); // NOI18N
        ...
        btnResetTabXemLai.setIcon(new javax.swing.ImageIcon("C:\\Users\\congc\\Documents\\NetBeansProjects\\QuanLyPizza\\image\\Refresh-icon.png")); // NOI18N
    ...
    private void btnThemVaoGioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemVaoGioActionPerformed
        ...
        try {
            ...
            new MyDialogCommon("Phải có số lượng và đơn giá nhập!", MyDialogCommon.ERROR_DIALOG);
            return;
        }
        ...
        if (row > -1) {
            ...
            new MyDialogCommon("Chưa chọn sản phẩm để nhập!", MyDialogCommon.ERROR_DIALOG);
        }
    ...
    private void btnXoaKhoiGioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaKhoiGioActionPerformed
        ...
        if (row > -1) {
            ...
            new MyDialogCommon("Chưa chọn sao xoá :)", MyDialogCommon.ERROR_DIALOG);
        }
    ...
    private void tblKhoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblKhoMouseClicked
        ...
        txtMaSp.setText(tblKho.getValueAt(row, 0)+"");
        txtTenSP.setText(tblKho.getValueAt(row, 1)+"");
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        if (row < 1) {
            new MyDialogCommon("Chưa có gì để nhập hết !", MyDialogCommon.ERROR_DIALOG);
            return;
        }
        ...
        if (nhaCungCap.equals("")) {
            new MyDialogCommon("Hãy chọn nhà cung cấp!", MyDialogCommon.ERROR_DIALOG);
            return;
        }
        
        List<CTPhieuNhap> lstCTPN = new ArrayList<>();
        for (int i = 0; i < row; i++) {
        ...
        XuatPhieuNhapView phieuNhapView = new XuatPhieuNhapView(nhaCungCap, nhanVien, lstCTPN);
        phieuNhapView.setVisible(true);
        if (phieuNhapView.getCheckNhap()) {
    ...
    private void btnChonNhaCungCapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChonNhaCungCapActionPerformed
        ...
        dlg.setVisible(true);
        if (dlg.getNCC() != null) {
            txtNhaCungCap.setText(dlg.getNCC().getMaNCC() + " - " + dlg.getNCC().getTenNCC());
        } else {
    ...
    private void tblPhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPhieuNhapMouseClicked
        ...
        PhieuNhap pn = phieuNhapServiceImp.timPhieuNhap(maPN);
        txtMaPN.setText(pn.getMaPN() + "");
        txtMaNCC.setText(pn.getNhaCungCap().getMaNCC() + "");
        txtMaNV.setText(pn.getNhanVien().getMaNV() + "");
    ...
    private void tblCTPhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCTPhieuNhapMouseClicked
        ...
        String tenSP = sanPhamServiceImp.getTenSP(Integer.parseInt(tblCTPhieuNhap.getValueAt(row, 0) + ""));
    ...
    private void btnResetKhoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetKhoActionPerformed
        List<SanPham> lst = sanPhamServiceImp.getListSP();
        loadDataTableKho();
        txtMaSp.setText("");
        txtTenSP.setText("");
        txtSoLuong.setText("");
