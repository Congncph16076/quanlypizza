...
public class DlgSuaNhaCungCap extends javax.swing.JDialog {
    ...
    public DlgSuaNhaCungCap(NhaCungCap ncc) {
        ...
        txtDienThoaiNCC.setText(ncc.getDienThoai());
    }

    public boolean getCheckSuaNhaCungCap() {
        return checkSuaNCC;
    }
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        NhaCungCapServiceImp nhaCungCapServiceImp = new NhaCungCapServiceImp();
        checkSuaNCC = nhaCungCapServiceImp.suaNCC(txtMaNCC.getText(), txtTenNCC.getText(), txtDiaChiNCC.getText(), txtDienThoaiNCC.getText());
        if (checkSuaNCC) {
            new MyDialogCommon("Thêm thất bại", MyDialogCommon.ERROR_DIALOG);
        }else{
             new MyDialogCommon("Thêm thành công!", MyDialogCommon.SUCCESS_DIALOG);
        }
